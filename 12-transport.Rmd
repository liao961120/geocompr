...
```{r include=FALSE}
dir.create('12-transport-figures')
dir <- '12-transport-figures/'
setcounter <- function() {
  counter <- 0
  function() {
    counter <<- counter + 1
...
download.file("https://user-images.githubusercontent.com/1825120/34452756-985267de-ed3e-11e7-9f59-fda1f3852253.png", destfile = temp)
