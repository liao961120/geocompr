...
\begin{center}\includegraphics{figures/new_raster-hist-1} \end{center}
...
\caption[Examples of geographic and projected CRSs (raster data).]{Examples of geographic (WGS 84; left) and projected (NAD83 / UTM zone 12N; right) coordinate systems for raster data.}(\#fig:raster-crs)
\end{figure}
