...
```{r include=FALSE}
dir.create('08-mapping-figures')
dir <- '08-mapping-figures/'
setcounter <- function() {
  counter <- 0
  function() {
    counter <<- counter + 1
...
temp <- paste0(dir, counter())
download.file("https://user-images.githubusercontent.com/1825120/39561412-4dbba7ba-4e9d-11e8-885c-7973b351006b.png", destfile = temp)
...
temp <- paste0(dir, counter())
download.file("https://user-images.githubusercontent.com/1825120/39979522-e8277398-573e-11e8-8c55-d72c6bcc58a4.png", destfile = temp)
knitr::include_graphics(temp)
...
temp <- paste0(dir, counter())
download.file("https://user-images.githubusercontent.com/1825120/39979271-5f515256-573d-11e8-9ede-e472ca007d73.png", destfile = temp)
knitr::include_graphics(temp)
...
temp <- paste0(dir, counter())
download.file("https://user-images.githubusercontent.com/1825120/39690606-8f9400c8-51d2-11e8-84d7-f4a66a477d2a.png", destfile = temp)
knitr::include_graphics(temp)
```
