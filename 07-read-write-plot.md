...
\caption[Sample of available vector drivers.]{(\#tab:drivers)Sample of available drivers for reading/writing vector data (it could vary between different GDAL versions).}
\centering
...
\caption[Data types supported by the raster package.]{(\#tab:datatypes)Data types supported by the raster package.}
\centering
\begin{tabular}{lll}
\toprule
