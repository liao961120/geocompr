...
\caption[Additional layers added to the output of Figure 8.1.]{Maps with additional layers added to the final map of Figure 8.1.}(\#fig:tmlayers)
\end{figure}
...
\caption[Selected tmap styles: bw, classic, cobalt and col_blind.]{Selected tmap styles: bw, classic, cobalt and col_blind (from left to right).}(\#fig:tmstyles)
\end{figure}
...
\caption[Faceted map showing urban agglomerations.]{Faceted map showing the top 30 largest urban agglomerations from 1970 to 2030 based on population projects by the United Nations.}(\#fig:urban-facet)
\end{figure}
...
{\centering \includegraphics{08-mapping-figures/1} 
...
{\centering \includegraphics{08-mapping-figures/2} 
...
{\centering \includegraphics{08-mapping-figures/3} 
...
{\centering \includegraphics{08-mapping-figures/4} 
